...
def comment_delete(request,id):
	...
	#obj = Comment.objects.get(id=id) ERROR WILL DISPLAY 
	try:
		obj = Comment.objects.get(id=id)
	except:
		raise Http404
	if obj.user != request.user:
		# messages.success(request,"You have no permission to view")
		# raise Http404	
...
def comment_thread(request,id):
	...
	content_object = obj.content_object  # Post on which the comment is or parent comment place
